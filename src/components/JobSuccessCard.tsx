...
const JobSuccessCard = () => {
    ...
    return (
        <Link href="#">
            <motion.div className="  lg:flex hidden flex-col space-y-2 z-[9] bg-[#F3FFFC] shadow-2xl py-2 px-3 rounded-lg ease-in duration-200 hover:scale-[102%] cursor-pointer" onMouseOver={() => useScale(false)} onMouseOut={() => useScale(true)}
